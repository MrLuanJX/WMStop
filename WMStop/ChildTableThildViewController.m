//
//  ChildTableThildViewController.m
//  WMStop
//
...
@interface ChildTableThildViewController ()
...
@implementation ChildTableThildViewController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(headerFresh:) name:@"headerThirdFresh" object:nil];
...
-(void)headerFresh:(NSNotification *)notification {
    ...
    if ([notificationName isEqualToString:@"headerThirdFresh"]) {
        NSLog(@"head刷新");
