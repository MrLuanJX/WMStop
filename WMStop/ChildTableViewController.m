...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(headerFresh:) name:@"headerFresh" object:nil];
...
-(void)headerFresh:(NSNotification *)notification {
    ...
    if ([notificationName isEqualToString:@"headerFresh"]) {
        NSLog(@"head刷新");
